...
if(isset($_POST['add_to_cart'])){
    ...
    $m_name = $_POST['m_name'];
    $m_price = $_POST['m_price'];
    $m_available_quantity = $_POST['m_available_quantity']; // Updated variable name
    ...
    if(mysqli_num_rows($select_cart) > 0){
        ...
        $insert_medicine = mysqli_query($conn, "INSERT INTO `cartt`(id, name, price, image, available_quantity, mfg_date, exp_date, company_name) VALUES ('$m_id', '$m_name', '$m_price', '$m_image', '$m_available_quantity', '$m_mfg_date', '$m_exp_date', '$m_company_name')");
        if($insert_medicine){
...
<section class="medicines">
   ...
   <h1 class="heading">MEDIPLUS RETAIL PHARMACY  </h1>
