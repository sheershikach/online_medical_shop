...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if ($result->num_rows > 0) {
        echo "<script>alert('Logout successfully done!!'); window.location.href='homepg1.html';</script>";
        exit();
    } else {
        echo "<script>alert('Invalid credentials. Please try again.'); window.location.href='adminlogout.html';</script>";
